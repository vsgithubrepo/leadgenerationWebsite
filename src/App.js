...
const globalStyles = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  /* Hide Clerk floating badge */
  .cl-internal-b3fm6y, [class*="cl-powered"], .cl-footer, .cl-userButtonPopoverFooter { display: none !important; }
  ...
  .cl-socialButtonsBlockButton {
    ...
    color: #e8e4dc !important; border-radius: 10px !important; height: 48px !important;
  ...
  .cl-formButtonPrimary {
    ...
    color: #0a0c0f !important; font-weight: 700 !important; border-radius: 10px !important;
    height: 48px !important; font-size: 14px !important; border: none !important;
    font-family: 'DM Sans', sans-serif !important; box-shadow: 0 4px 20px rgba(245,158,11,0.3) !important;
  }
...
// ── Logo — loads from public/etechcube-logo.jpg ─────────────────
export function Logo({ height = 52, style = {} }) {
  return (
    <img
      src="/etechcube-logo.jpg"
      alt="eTechCube"
    ...
    return (
      <div style={{ display:'flex', alignItems:'center', justifyContent:'center', height:'100vh', background:'#0a0c0f' }}>
        <div style={{ background:'#111418', border:'1px solid rgba(239,68,68,0.25)', borderRadius:16, padding:'48px 40px', textAlign:'center', maxWidth:400 }}>
          <Logo height={48} style={{ margin:'0 auto 20px' }} />
    ...
    <div style={S.page}>
      ...
      <div style={S.right}>
        <div style={S.card}>
          ...
          <h2 style={S.cardH2}>Welcome back</h2>
          <p style={S.cardSub}>Sign in with your {COMPANY_NAME} Google account</p>
          ...
          <SignIn
            ...
            redirectUrl="/"
          />
          <div style={S.cardFooter}>🔐 Secured by Clerk · HTTPS encrypted</div>
        </div>
      </div>
...
function AuthGate() {
  ...
  return <DomainGuard><LeadEngine Logo={Logo} /></DomainGuard>;
}
...
export default function App() {
  if (!CLERK_KEY) return (
    <div style={{ display:'flex', alignItems:'center', justifyContent:'center', height:'100vh', background:'#0a0c0f' }}>
      <div style={{ background:'#111418', borderRadius:16, padding:'48px 40px', textAlign:'center', maxWidth:440, color:'#e8e4dc' }}>
        <h2 style={{ fontFamily:"'Syne',sans-serif", marginBottom:8, fontWeight:800 }}>Setup Required</h2>
        <p style={{ color:'#9ca3af', fontSize:14, marginBottom:16 }}>Add your Clerk key to environment variables</p>
        <code style={{ display:'block', background:'#1e2530', padding:'10px 16px', borderRadius:8, fontSize:12, color:'#f59e0b' }}>
...
const S = {
  ...
  h1:         { fontFamily:"'Syne',sans-serif", fontWeight:800, fontSize:48, lineHeight:1.1, letterSpacing:'-2px', color:'#e8e4dc', marginBottom:20 },
  ...
  card:       { width:'100%', maxWidth:360, display:'flex', flexDirection:'column', animation:'fadeIn 0.5s ease 0.1s both' },
  cardH2:     { fontFamily:"'Syne',sans-serif", fontWeight:800, fontSize:24, color:'#e8e4dc', marginBottom:6, letterSpacing:'-0.5px' },
